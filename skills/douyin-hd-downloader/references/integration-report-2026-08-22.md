...
> ⚠️ **本报告只覆盖了顺利的那条路径。** 它跑的是 12 档 `bit_rate[]` + 浏览器回退的形态，且只跑了一次，因而漏掉了首版约 30% 的间歇失败率与静默水印降级。
> 另一种形态（0 档 `bit_rate[]`、纯 SSR）见 [`integration-report-2026-08-22-b.md`](integration-report-2026-08-22-b.md)。
